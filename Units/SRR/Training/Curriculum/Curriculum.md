# [RESTRICTED] SRR TRAINING CURRICULUM (THE BLACK COURSE)
...
1. **Theoretical Review:** 30-minute Initial Candidate Evaluation (ICE) followed by practical navigation check.
...
### 2.1 SURVEILLANCE & PHOTOGRAPHY (2-HOUR MODULE)
- **Observation Posts:** Construction and concealment of static OPs.
- **Optics:** Advanced utilization of long-range optics and digital imagery collection.
- **Pattern of Life:** Methodology for documenting and analysing HVT activity.

### 2.2 COMMUNICATIONS (ACRE-2) (2-HOUR MODULE)
- **Signal Discipline:** Radio protocols and the maintenance of signal security.
- **Antenna Theory:** Employment of advanced and field-expedient antenna systems.
- **COMSEC:** Implementation of encryption and frequency-hopping procedures.

### 2.3 BATTLEFIELD TECHNOLOGY (cTAB) (2-HOUR MODULE)
- **BFT Management:** Synchronization of the Blue Force Tracker network.
...
### 3.1 CLOSE TARGET RECONNAISSANCE (CTR) (2-HOUR MODULE)
- **Infiltration:** Infil/Exfil techniques including sub-surface and maritime insertion.
- **Covert Movement:** Tactical movement within 50m of hostile positions while remaining undetected.
- **PIR Identification:** Methodology for satisfying Priority Intelligence Requirements.

### 3.2 COUNTER-SURVEILLANCE & EVASION (2-HOUR MODULE)
- **Threat Identification:** Identification of hostile surveillance and EW efforts.
