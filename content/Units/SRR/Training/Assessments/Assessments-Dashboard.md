# [RESTRICTED] SRR ASSESSMENTS & EVALUATIONS

This folder contains the formalized theoretical and practical assessments for SRR candidates.
...
```dataview
LIST FROM "Units/SRR/Training/Assessments/Results"
```
