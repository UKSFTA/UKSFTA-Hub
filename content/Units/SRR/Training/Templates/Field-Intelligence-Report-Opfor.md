...
- **OPFOR 1 (Guard Lead):** Equipped with a radio and sidearm.
    
- **OPFOR 2 (Sentry):** Equipped with a rifle; stays at TRP 1.
    
- **OPFOR 3 (HVT Courier):** Distinct clothing (e.g., Tan vest, no helmet, civilian headgear).
...
|**T+22:00**|OPFOR 1|**Comms Check:** OPFOR 1 climbs to the highest visible point (e.g., roof/balcony) and utilizes a handheld radio for 30 seconds.|PIR 5 (Comms/C2)|
|**T+30:00**|OPFOR 1 & 3|**The Transfer:** OPFOR 1 meets OPFOR 3 at the vehicle. A physical item (hard case) is transferred. HVT is clearly visible.|PIR 1 (HVT ID)|
...
- **VISIBILITY:** Do not hide inside buildings for the entire window. If the candidate can't see you, they can't report on you. Ensure the "Transfer" at T+30:00 happens in an open courtyard or road.
    
- **THERMAL DISCIPLINE:** OPFOR should intentionally use a flashlight or smoke a cigarette once during the night phase to see if the candidate notices the thermal/light bloom.
