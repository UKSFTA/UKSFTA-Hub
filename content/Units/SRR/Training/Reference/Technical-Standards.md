# [RESTRICTED] SRR TECHNICAL STANDARDS: ACE, ACRE-2, & cTAB
...
### **Procedures:**
- **Emission Control:** Utilization of the minimum required power setting (EMCON) to mitigate the risk of electronic triangulation.
- **COMSEC:** Verification of encryption keys and frequency settings prior to infiltration.
...
### **Standards:**
- **Individual Loadout:** Minimum of 4x Tourniquets, 6x Bandages, 2x Morphine, and 2x Epinephrine.
...
### **Employment:**
- **Mobile Device (FBCB2):** Individual navigation and personal situational awareness.
- **Rugged Tablet:** Patrol Lead asset for intelligence marking and multi-unit coordination.
- **Symbology Protocol:** 
  - Red = Hostile (Confirmed)
  - Yellow = Unknown/Suspected
  - Blue/Green = Friendly/Allied
