# [RESTRICTED] RSIS TECHNICAL STANDARDS: SIGINT, HUMINT, SSE
...
**"If they speak, we hear."**

### **Procedures:**
- **The Scan:** Continuous monitoring of the 30-80MHz (VHF) spectrum using ACRE racks.
- **The Log:** All intercepts are logged immediately.
    - Format: *Time (Z) - Frequency - Speaker - Message - Assessment*
...
- **The "Shock" Period:** The first 60 seconds after capture are statistically the most productive.
- **Safety:** Never question a detainee alone. The "Coverman" maintains security; the "Questioner" conducts the engagement.
...
1.  **Digital Media:** Laptops, Phones, Hard Drives (Strategic value).
2.  **Pocket Litter:** ID cards, receipts, documents (Tactical value).
3.  **Technical Data:** Serial numbers, equipment markings (Logistical tracking).
...
- **Priority Interjection:** RSIS operators have "Priority Net" authority for time-critical threat warnings (e.g., "QRF inbound North, 2 mikes").
