# [RESTRICTED] SBS TRAINING CURRICULUM
...
1. **SC Aptitude:** 1-hour Swimmer Canoeist (SC) breath-holding/swimming assessment followed by a 1-hour tactical exercise.
...
### 2.1 AMPHIBIOUS INFILTRATION (2-HOUR MODULE)
- **Surface Operations:** Surface swimming and tactical kayaking (Klepper).
- **Surface Craft:** RHIB and raiding craft operations.
- **Sub-Surface:** Sub-surface insertion using rebreathers.

### 2.2 SHIP BOARDING (VBSS) (2-HOUR MODULE)
- **VBSS Protocols:** Visit, Board, Search, and Seizure.
- **Access:** Fast-rope, hook-and-climb, and ladder boarding techniques.
- **Maritime CQB:** Close Quarters Battle in restricted maritime environments.

### 2.3 UNDERWATER DEMOLITIONS (2-HOUR MODULE)
